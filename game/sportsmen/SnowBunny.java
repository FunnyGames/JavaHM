...
public class SnowBunny {
     ...
     */
    public SnowBunny(String name, double maxSpeed, double age, double acceleration, String qualification, String gender, String league) {
        this.name = name;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SnowBunny))
            return false;

        SnowBunny o = (SnowBunny) other;
